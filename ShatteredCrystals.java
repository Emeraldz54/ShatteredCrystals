    ...
    public static void main(String[] args){
        ...
        while(!hasChosenToLoad){
            ...
            switch(loadChoice){
                ...
                boolean choosingStoryline = true;
                while(choosingStoryline){
                    System.out.println("Would you like to read the intro? [y/n]");
                    String choice = ui.nextLine();
                    switch(choice){
                        case "y":
                        System.out.println("Okay! Starting intro now.");
                        userCharacter.storylineIntro();
                        choosingStoryline = false;
                        break;

                        case "n":
                        System.out.println("Okay! Intro skipped.");
                        choosingStoryline = false;
                        break;
            ...
            if(!userCharacter.atBenchmark){
                ...
                switch(choice){
                    ...
                    while(traveling){
                        ...
                        switch(userCharacter.location){
                            case 0:
                            System.out.println("You are currently in the Plains.");
                            break;

                            case 1:
                            System.out.println("You are currently in the Forest.");
                            break;

                            case 2:
                            System.out.println("You are currently in the Mountains.");
                            break;

                            case 3:
                            System.out.println("You are currently in the Castle.");
                            break;

                            default:
                            System.out.println("Something seems to have messed up. Your location doesn't exist.");
                            break;
                        }
                        if(userCharacter.unlockedLoc >= 1){
                            System.out.println("You have unlocked "+(userCharacter.unlockedLoc + 1)+" locations."); }
                        else{
                            System.out.println("You have unlocked 1 location.");
                        }
                        System.out.println("The locations are: \n1: Plains \n2: Forest\n3: Mountains\n4: Castle");
                        System.out.print("Please input the number of the location you would like to travel to, or 'exit':");
                        String travelChoice = ui.nextLine();
                        switch(travelChoice){
                            case "1":
                            System.out.println("You have traveled to the Plains!");
                            userCharacter.location = 0;
                            traveling = false;
                            break;

                            case "2":
                            if(userCharacter.unlockedLoc >= 1){
                                System.out.println("You have traveled to the Forest!");
                                userCharacter.location = 1;
                                traveling = false;
                            }
                            else{
                                System.out.println("You have not unlocked that location!");
                            }
                            break;

                            case "3":
                            if(userCharacter.unlockedLoc >= 2){
                                System.out.println("You have traveled to the Mountains!");
                                userCharacter.location = 2;
                                traveling = false;
                            }
                            else{
                                System.out.println("You have not unlocked that location!");
                            ...
                            case "4":
                            if(userCharacter.unlockedLoc >= 3){
                                System.out.println("You have traveled to the Forest!");
                                userCharacter.location = 3;
                                traveling = false;
                            }
                            else{
                                System.out.println("You have not unlocked that location!");
                            ...
                            case "exit":
                            System.out.println("You have decided not to travel.");
                            traveling = false;
                            break;

                            default:
                            System.out.println("Oops! That's not one of the options!");
                            break;
                    ...
                    while(!hasDecided){
                        ...
                        switch(wesChoice){
                            ...
                            if(mobChance<60){
                                ...
                                Monster m = new Monster(id, userCharacter);
                    ...
                    if(Math.random()*100>3){
                        int id = (int)(Math.random()*3) + (3*userCharacter.location);
                        Monster m = new Monster(id, userCharacter);
                        Battle bat = new Battle();
                        bat.main(userCharacter, m);
                    }
                ...
                userCharacter.atBenchmark = false;
                System.out.println("You glance down at the ground, and you see at your feet-\n\nA CRYSTAL SHARD!");
                System.out.println("\nYou pick it up, and a light surrounds the crystal. It absorbs into you.");
                System.out.println("You feel a strange knowledge; you know where the next location is!");
                System.out.println("You also feel a great deal stronger.");
                userCharacter.str += 3;
                userCharacter.vit += 10;
                userCharacter.att += 3;
                userCharacter.def += 3;
                userCharacter.unlockedLoc++;
                userCharacter.incDef = userCharacter.def*3/2;
                userCharacter.dex += 3;
                userCharacter.magAtt += 3;
                userCharacter.mana += 5;
                userCharacter.manaReg += 1;
                userCharacter.hp = userCharacter.vit;
                try {
                    Thread.sleep(1000);
                } catch(InterruptedException ex) {
                ...
                boolean decidingShop = true;
                while(decidingShop){
                    System.out.println("You see a shoppe on the side of the road!\nIt looks special. Would you like to stop by? [y/n]");
                    String shopDec = ui.nextLine();
                    switch(shopDec){
                        case "y":
                        System.out.println("You enter the shop!");
                        System.out.println("But it's empty because it isn't added yet. Sorry!");
                        /*
                         * System.out.println("The inside of the shop is rather eerie. Spiderwebs and the like.");
                         * System.out.println("A man with a crooked and moth-eaten wizard hat glances up at you.");
                         * boolean choosingSecShop = true;
                         * while(choosingSecShop){
                         *     System.out.println("'What would you like?' he asks.");
                         *     System.out.println("('help' if you don't know your options)");
                         *     String secShopChoice = ui.nextLine();
                         *     switch(secShopChoice){
                         *         case "skill points":
                         *         System.out.println("'We've got quite the training regiment!' he said.\n'What do you want me to help you learn?'");
                         *         break;
                         *         
                         *         case "spell":
                         *         System.out.println("'Only shoppe in this reality to sell spells!' he said, beaming.\n'What do you see to your liking?'");
                         *         break;
                         *         
                         *         case "special equipment":
                         *         System.out.println("'We have a special inventory here at the Secret Shoppe,' he declares.\n'What do you see to your liking?'");
                         *         break;
                         *         
                         *         case "help":
                         *         System.out.println("Your options are:\n'help', 'skill points', 'spell', 'special equipment', or 'exit'.");
                         *         break;
                         *         
                         *         case "exit":
                         *         choosingSecShop = false;
                         *         System.out.println("You have left the Secret Shoppe.");
                         *         break;
                         *         
                         *         default:
                         *         System.out.println("Please type 'help', 'skill points', 'spell', 'special equipment', or 'exit'.");
                         *         break;
                         *         }
                         *     }
                         * 
                        ...
                        case "n":
                        System.out.println("You pass it by.");
                        decidingShop = false;
                        break;
