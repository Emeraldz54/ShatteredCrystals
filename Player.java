 ...
 * Has player's stats
 * 
 * DISCLAIMER FOR COLLEGEBOARD: This class was a combined effort between Michael Lee
 * and Justin Goodberry. However, the function mentioned in the written responses-
 * the attack() function- was written by Justin Goodberry.
 */
...
public class Player extends Character{
    ...
    public void storylineIntro(){
        System.out.println("Welcome to ShatteredCrystals!\nI am here to guide you through this journey,\nthough my name is irrelevant.");
        hsd();
        System.out.println("You are currently in the world of Terran, where\nmagic, swordplay, archery, and other things run rampant.");
        hsd();
        System.out.println("I am what many consider to be a god.");
        hsd();
        System.out.println("I'm also called a narrator by others.");
        hsd();
        System.out.println("You, child, what is your name? Tell me now...");
        hsd();
        System.out.println("Just kidding, I know what your name is, and don't really care.");
        hsd();
        if(className == 1){
            System.out.println("You are a warrior, are you not? You're destined for great things.\nYou must also protect this land, for I have seen the end of all things.");
            hsd();
            System.out.println("Your swordsmanship must be unmatched, if you plan to embark on\nthis journey of yours! What's that?");
            hsd();
        }
        if(className == 2){
            System.out.println("You are an archer, are you not? You're destined for great things.\nYou must also protect this land, for I have seen the end of all things.");
            hsd();
            System.out.println("I know your accuracy is that of an expert marksman! You are ready\nto embark on this journey of yours!\nWhat's that?");
            hsd();
        }
        if(className == 3){
            System.out.println("You are a rogue, are you not? You're destined for great things.\nYou must also protect this land, for I have seen the end of all things.");
            hsd();
            System.out.println("Your stealthiness is preposterous! Embark on the journey to save this world.\nWhat's that?");
            hsd();
        }
        if(className == 4){
            System.out.println("You are a mage, are you not? You're destined for great things.\nYou must also protect this land, for I have seen the end of all things.");
            hsd();
            System.out.println("Your intelligence is that of an expert scholar! You are prepared to\nembark on this journey in front of you.\nWhat's that?");
            hsd();
        }
        if(className == 5){
            System.out.println("You are overpowered! Just go ahead and embark on this journey.\nProtect this world, young prodigy!\nWhat's that?");
            hsd();
        }
        if(className > 5 && className <= 7){
            System.out.println("You're on a testing class, so either you're me\nor you're an expert guesser. Go on the journey already.\nWhat's that?");
            hsd();
        }
        System.out.println("What journey? What do you mean what journey?");
        hsd();
        System.out.println("Well, you just happened to be chosen by the king himself!");
        hsd();
        System.out.println("To do what, you ask? Well, you were told less than I thought...");
        hsd();
        System.out.println("The evil Baron Nashor of the northern Void Kingdoms sent a spy\nto cause a large portion of mayhem. He was tasked with\nbreaking the Crystal Light.");
        hsd();
        System.out.println("What do you MEAN you don't know what the Crystal Light is?\nIt's only the most important relic of this land!");
        hsd();
        System.out.println("Well, it just happens to hold the whole world together, or\nis rumored to. It is also the source of most\nthe world's power.");
        hsd();
        System.out.println("So, I have told you all this! You must collect the Crystal Shards\nwhich were scattered across this land!");
        hsd();
        System.out.println("You have been told this by the god of Terran himself!");
        hsd();
        System.out.println("Yes, I am a god! Do not question me, mortal!");
        hsd();
        System.out.println("What? A mortal programming the game? NO! I am god of Terran!");
        hsd();
        System.out.println("I have reduced your hp to 1 for your insolence!");
        hsd();
        ...
        hsd();
        System.out.println("Only by my good graces will I raise your health once more!");
        hsd();
        System.out.print("Your hp: ");
        try {
            Thread.sleep(1000);
        ...
        hsd();
        System.out.println("Now go, foolish mortal! Embark on this journey, and\ntake down the evil Baron Nashor!");
        hsd();
    }

    //Delays for two and a half seconds, as well as printing a line. For convenience with coding the intro :)
    public void hsd(){
        try {
            Thread.sleep(2500);
        }catch(InterruptedException ex) {
    ...
    /*
     * The function below is used for the responses, and is a part of the
     * Player class, but the rest of the Player class is irrelevant
     * to this project, and is, as such, not shown.
     */
    ...
    //Shows the battle choice in the battle class. i hope
    public List userBattleChoice(){
            ...
            switch(userChoice){
                ...
                while(!hasChosenSpell){
                    ...
                    if(spellChoice == 0)
                        ...
                        spellChoice--;
                        if(spellbook.get(spellChoice).manaCost <= mana){
                            hasChosenSpell = true;
                            userChoice = "spell";
                            currentUserSpell = spellbook.get(spellChoice);
                            chosen = true;
                        }
                        else{
                            hasChosenSpell = true;
                ...
                case"special":
                if(lvl >= 3){
                    System.out.println("You used " + specialname);
                    chosen = true;
                }
                else{
